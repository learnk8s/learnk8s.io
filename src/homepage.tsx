        ...
        <div className='w-50-l center'>
          ...
          <div className='measure-wide'>
            ...
            <ul className='list black-70 pl0 pt2'>
              ...
              <ListItem>Architect micro-services that scale and leverage the strength and weaknesses of the platform</ListItem>
              <ListItem>Get up to speed quickly without drowning in the amount of incomplete/outdated documentation</ListItem>
            </ul>
          </div>
        </div>
