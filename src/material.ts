  ...
  zeroToKubernetes: {
    ...
    topics: {
      ...
      containerOrchestrators: {
        ...
        image: Image({url: 'assets/material/orchestrators-2.svg', description: 'Kubernetes, Apache Mesos, Hashicorp Nomad'}),
      },
      datacentreAsVM: {
        title: 'Visualising the data centre as a single VM',
        image: Image({url: 'assets/material/dc-single-vm-7.svg', description: 'Data centre as single a virtual machine'}),
      },
      tetrisPlayer: {
  ...
  architecture: {
    ...
    topics: {
      ...
      events: {
        ...
        image: Image({url: 'assets/material/43-architecture.svg', description: 'Controller manager reacts to an event'}),
      },
      kubelet: {
      ...
      noSinglePointOfFailure: {
        ...
        image: Image({url: 'assets/material/70-architecture.svg', description: 'Testing failover in a Kubernetes cluster'}),
      },
      multiNodes: {
      ...
      eks: {
        ...
        image: Image({url: 'assets/material/85-architecture.svg', description: 'Amazon Elastic Container Service for Kubernetes'}),
      },
      monzo: {
...
export const material: {
  [section in (keyof typeof content)]: {
    ...
    description: string
    topics: {
      [topic in keyof typeof content[section]['topics']]: string
    }
  }
} = Object.keys(content).reduce((acc: any, key) => {
