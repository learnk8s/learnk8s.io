  ...
  return renderToStaticMarkup(
    ...
    >
      ...
      <section className='bg-black-02 black-70 relative z-999 w-90-m w-70-l center pa3 pa4-ns mb3 mb5-ns lh-copy'>
        ...
        <p>
          Write a deployment for Kubernetes. You can find the details on how to complete the challenge at the following
          link:{' '}
        ...
        <p>
          Once you solved the challenge, please send us a link with your repository and a link to your Linkedin profile
          at{' '}
