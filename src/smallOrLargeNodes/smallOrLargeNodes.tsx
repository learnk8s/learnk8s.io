...
export const Details = {
  ...
  shortDescription: `When you create a Kubernetes cluster, one of the first questions that pops up is: "what type of worker nodes should I use and how many of them?". This article look at the pros and cons of either using many small nodes or few large nodes.`,
  description: `When you create a Kubernetes cluster, one of the first questions that pops up is: "what type of worker nodes should I use and how many of them?". You can achieve a desired cluster capacity (in terms of CPU and memory) equally with many small nodes or with few large nodes. But which way is better? This article looks at the pros and cons of both approaches.`,
