...
import { LinkedNode, AboutUsPage, Website } from './sitemap'
...
export const AboutUs: React.StatelessComponent<{root: Website, currentPage: LinkedNode<AboutUsPage, object>, siteUrl: string, assets: typeof assets}> = ({assets, root, siteUrl, currentPage}) => {
    ...
    <div className='trapezoid-1 white pt3 pt0-ns pb2 pb4-ns'>
      ...
      <section className="ph5-l">
        <div className="w-100">
          ...
          <h2 className="f4 normal measure-narrow lh-copy ph3 ph4-ns f3-l pb4">Experienced software consultants, specialising in Kubernetes.</h2>
        </div>
      </section>
    ...
    <section>
      <ul className="list pl0 flex flex-wrap justify-center">
        <Profile
          ...
          <GitHub link='https://github.com/danielepolencic'></GitHub>
          <Twitter link='https://twitter.com/danielepolencic'></Twitter>
          <LinkedIn link='https://www.linkedin.com/in/danielepolencic'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.miriam}
          ...
          <LinkedIn link='https://www.linkedin.com/in/miriam-menegatti-46263915/'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.bruno}
          name='Bruno Bonanno'
          ...
          <GitHub link='https://github.com/bbonanno'></GitHub>
          <LinkedIn link='https://www.linkedin.com/in/bbonanno/'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.alessandro}
          ...
          <LinkedIn link='https://www.linkedin.com/in/alemoretti/'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.mehdi}
          name='Mehdi Avdi'
          ...
          role='Instructor'>
          <GitHub link='https://github.com/mavdi'></GitHub>
          <LinkedIn link='https://www.linkedin.com/in/mehdiavdi/'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.chris}
          ...
          role='Instructor'>
          <GitHub link='https://github.com/chrisns'></GitHub>
          <LinkedIn link='https://www.linkedin.com/in/cnesbittsmith/'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.valentin}
          ...
          <GitHub link='https://github.com/valentin2105'></GitHub>
          <Twitter link='https://twitter.com/valentin_nc'></Twitter>
          <LinkedIn link='https://www.linkedin.com/in/valentin-ouvrard-57823aa7'></LinkedIn>
        </Profile>
        <Profile
          profile={assets.page.keith}
          name='Keith Mifsud'
          ...
          <GitHub link='https://github.com/keithmifsud'></GitHub>
          <Twitter link='https://twitter.com/keithmifsud'></Twitter>
          <LinkedIn link='https://www.linkedin.com/in/keith-mifsud-369275157'></LinkedIn>
          <World link='https://keith-mifsud.me'></World>
        </Profile>
      </ul>
    </section>
...
export const GitHub: React.StatelessComponent<{link: string}> = ({link}) => {
  return <a href={link} target="_blank" rel="noopener" className="link fl w2 h2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
      <path fill="#4791CD" d="M30 6C16.8 6 6 17 6 30.6 6 41.5 12.9 50.7 22.4 54c1.2.2 1.6-.5 1.6-1.2v-4.2c-6.7 1.5-8.1-3.3-8.1-3.3-1.1-2.8-2.7-3.6-2.7-3.6-2.2-1.5.2-1.5.2-1.5 2.4.2 3.7 2.5 3.7 2.5 2.1 3.8 5.6 2.7 7 2 .2-1.6.8-2.7 1.5-3.3-5.3-.6-10.9-2.7-10.9-12.2 0-2.7.9-4.9 2.5-6.6-.2-.6-1.1-3.1.2-6.5 0 0 2-.7 6.6 2.5 1.9-.5 4-.8 6-.8s4.1.3 6 .8c4.6-3.2 6.6-2.5 6.6-2.5 1.3 3.4.5 5.9.2 6.5 1.5 1.7 2.5 3.9 2.5 6.6 0 9.5-5.6 11.5-11 12.1.9.8 1.6 2.3 1.6 4.6v6.8c0 .7.4 1.4 1.7 1.2C47.2 50.7 54 41.5 54 30.6 54 17 43.3 6 30 6z"/>
    </svg>
  </a>
}
...
export const LinkedIn: React.StatelessComponent<{link: string}> = ({link}) => {
  return <a href={link} target="_blank" rel="noopener" className="link fl w2 h2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
      <path fill="#4791CD" d="M14.8 10c-2.9 0-4.8 2-4.8 4.7 0 2.6 1.8 4.7 4.7 4.7h.1c2.9 0 4.8-2.1 4.8-4.7-.2-2.7-2-4.7-4.8-4.7zM11 22.8h7.8V50H11zm29.1-.2c-4.5 0-7.3 2.7-7.8 4.5v-4.3h-8.8c.1 2.3 0 27.2 0 27.2h8.8V35.3c0-.8 0-1.6.2-2.2.6-1.6 1.9-3.3 4.2-3.3 3 0 4.4 2.5 4.4 6.2v14H50V34.9c0-8.4-4.4-12.3-9.9-12.3z"/>
    </svg>
  </a>
}
...
export const World: React.StatelessComponent<{link: string}> = ({link}) => {
  return <a href={link} target="_blank" rel="noopener" className="link fl w2 h2">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90">
      <path d="M44.8 15.2C27.8 15.2 14 29 14 46s13.8 30.8 30.8 30.8S75.6 63 75.6 46c.1-17-13.7-30.8-30.8-30.8zm0 57.8c-3.8 0-7.4-.8-10.7-2.2l14-15.8c.3-.4.5-.8.5-1.3v-5.8c0-1.1-.9-1.9-1.9-1.9-6.8 0-14-7.1-14.1-7.1-.4-.4-.8-.6-1.4-.6h-7.7c-1.1 0-1.9.9-1.9 1.9v11.6c0 .7.4 1.4 1.1 1.7l6.7 3.3v11.3c-7-4.9-11.6-13-11.6-22.2 0-4.1.9-8.1 2.6-11.6h7c.5 0 1-.2 1.4-.6l7.7-7.7c.4-.4.6-.9.6-1.4v-4.7a27.267 27.267 0 0 1 19.5 1.6c-.2.2-.5.4-.7.7-2.2 2.2-3.4 5.1-3.4 8.2 0 3.1 1.2 6 3.4 8.2 2.2 2.2 5.1 3.4 8.2 3.4h.6c.8 3.1 2.3 11.2-.5 22.4v.3c-5 5.2-11.8 8.3-19.4 8.3zm0 0" fillRule="evenodd" clipRule="evenodd" fill="#4791cd"/>
    </svg>
  </a>
}