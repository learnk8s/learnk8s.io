...
import { mailto, MailTo, FAQs, FAQ } from './layout.v2'
...
setTimeout(ldinsp, 0);
        ...
        <Section className='bg-evian'>
          <div className='mt4 pb4 pb5-l'>
            ...
            <p className='measure f3-l f4 lh-copy center i'>
              Are you confident debugging incidents in the prod cluster?
            </p>
          </div>
        </Section>
...
request.send();
      `,
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(w,d,v3){
    w.chaportConfig = {
      appId : '5dc2975173dc900c887b6e53'
    };
