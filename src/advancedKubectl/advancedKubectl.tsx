...
export function render(website: Sitemap, currentNode: LinkedNode<typeof Details>, siteUrl: string): JSX.Element {
  return (
    <Article
      website={website}
      ...
      <script type='application/ld+json'>
        {JSON.stringify(
          identity<WithContext<BlogPosting>>({
            ...
            image: `${siteUrl}${(currentNode.payload.previewImage as any).properties.src}`,
            author: {
              '@type': 'Person',
            ...
            publisher: {
              ...
              logo: {
                '@type': 'ImageObject',
                url: `${siteUrl}/assets/learnk8s_logo_square.png`,
              },
            },
