...
![Kubectl explain](asciicast-kubectl-explain.cast)
...
![Kubeconfig aliases](asciicast-kubeconfig-aliases.gif)
...
![Hello World kubectl plugin](asciicast-plugins-hello.cast)
...
![Krew plugin](asciicast-plugins-krew.cast)
