      ...
      <section className='flex-ns items-start-ns justify-around-ns pr3-m pr7-l'>
        ...
        <div className='dn db-ns'>
          ...
          <ul className='list pl0'>
            <li className='mv2'>
              <a href='/training' className='link white'>
                Training
              </a>
            </li>
            <li className='mv2'>
              <a href='/academy' className='link white'>
                Academy
              </a>
            </li>
            <li className='mv2'>
              <a href='/consulting' className='link white'>
                Consulting
              </a>
            </li>
          </ul>
        ...
        <div className=''>
          ...
          <ul className='list pl0'>
            <li className='mv2'>
              <a href='/contact-us' className='link white'>
                Contact us
              </a>
            </li>
            <li className='mv2'>
              <a href='/about-us' className='link white'>
                Team
              </a>
            </li>
            <li className='mv2'>
              <a href='/careers' className='link white'>
                Careers
              </a>
            </li>
            <li className='mv2'>
              <a href='/blog' className='link white'>
                Blog
              </a>
            </li>
            <li className='mv2'>
              <a href='/newsletter' className='link white'>
                Newsletter
              </a>
            </li>
          </ul>
