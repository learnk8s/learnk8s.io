...
export const Details = {
  ...
  previewImage: Image({url: 'src/scalingSpringBoot/autoscaling.png', description: 'Scaling Microservices with Message Queues, Spring Boot and Kubernetes'}),
  author: {
...
export function render(website: Sitemap, currentNode: LinkedNode<typeof Details>, siteUrl: string): string {
  ...
  return renderToStaticMarkup(<Article
    ...
    <RelatedConentContainer>
      ...
      <RelatedContentItem>
        <a href={getFullUrl(website.children.blog.children.chaosEngineering)} className='link navy underline hover-sky'>Kubernetes Chaos Engineering: Lessons Learned — Part 1</a>what happens when things go wrong in Kubernetes? Can Kubernetes recover from failure and self-heal?
      </RelatedContentItem>
    </RelatedConentContainer>
    ...
    <JSScript js={JSBundle({
      scripts: js,
      paths: [
        'src/scalingSpringBoot/anime.min.js',
        'src/scalingSpringBoot/isScrolledIntoView.js',
      ]
    })}/>
  </Article>)
}