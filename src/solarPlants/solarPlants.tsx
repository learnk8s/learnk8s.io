...
export const Details = {
  ...
  previewImage: Image({url: 'src/solarPlants/solar_panel.png', description: 'Cloud infrastructure for the Internet of Things: Kubernetes on solar plants'}),
  author: {
...
export function render(website: Sitemap, currentNode: LinkedNode<typeof Details>, siteUrl: string): string {
  ...
  return renderToStaticMarkup(<Article
    ...
    <RelatedConentContainer>
      ...
      <RelatedContentItem>
        <a href={getFullUrl(website.children.blog.children.scalingSpringBoot)} className='link navy underline hover-sky'>Kubernetes Chaos Engineering: Lessons Learned — Part 1</a> what happens when things go wrong in Kubernetes? Can Kubernetes recover from failure and self-heal?
      </RelatedContentItem>
    </RelatedConentContainer>
    ...
    <JSScript js={JSBundle({
      scripts: js,
      paths: [
        'src/solarPlants/anime.min.js',
        'src/solarPlants/isScrolledIntoView.js',
      ]
    })}/>
  </Article>)
}